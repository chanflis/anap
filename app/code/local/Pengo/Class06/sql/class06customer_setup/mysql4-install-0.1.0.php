...
$installer->addAttribute("customer", "interests", array(
    "type"     => "varchar",
    "backend"  => "",
    "label"    => "Interests",
    "input"    => "multiselect",
    "source"   => "class06/source_customer_interests",
    "visible"  => true,
    "required" => false,
    "default"  => "",
    "frontend" => "",
...
$attribute = Mage::getSingleton("eav/config")->getAttribute("customer", "interests");
